...
namespace AircompanyTests.Tests
{
    ...
    {
        private Airport airport = new Airport(new List<Plane>(){
        ...
        private bool IsTransportMilitaryPlanes()
        {
        ...
        private bool IsSortByMaxLoadCapacityWorks()
        {
        ...
        [Test]
        public void IsTransportMilitaryPlanesTest()
        {
            Assert.IsTrue(IsTransportMilitaryPlanes());
        }
        ...
        [Test]
        public void IsSortByMaxLoadCapacityWorksTest()
        {
            Assert.IsTrue(IsSortByMaxLoadCapacityWorks());
        }
    }
}
