...
namespace Framework.Pages
{
    public class HotelPage
    {
        ...
        private IWebElement toggle_Notification
        {
            get 
            {
                wait.Until(ExpectedConditions.ElementIsVisible(By.XPath(".//label[@class='label withLabel']")));
                return driver.FindElement(By.XPath(".//label[@class='label withLabel']")); 
            }
        }
        ...
        public string get_ButtonMailDisabledInfo
        {
            get 
            {
                wait.Until(ExpectedConditions.ElementIsVisible(By.XPath(".//div[@class='driveBySubmit']//button")));
                return driver.FindElement(By.XPath(".//div[@class='driveBySubmit']//button")).GetAttribute("disabled"); 
            }
        }
