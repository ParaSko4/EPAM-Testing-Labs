...
namespace Framework
{
    ...
    public class FirefoxRequests
    {
        ...
        {
            FlightsPage flights = new FlightsPage(driver).InputDepartureCityValue(FlightsCreator.WithAllProperties())
        ...
        {
            FlightsPage flights = new FlightsPage(driver).PressTravelers()
        ...
        {
            FlightsPage flights = new FlightsPage(driver).PressRoundTrip()
        ...
        {
            HotelPage hotel = new HotelPage(driver).InputArrivalCityValue(FlightsCreator.OnlyArrivalCity())
                                                    .PressSearch()
        ...
        {
            HotelPage hotel = new HotelPage(driver).PressSearch();
        ...
        {
            HotelPage hotel = new HotelPage(driver).PressGuests()
